 ...
 */
declare function withElementById(id: string, offdom?: boolean): Builder;
declare let Build: {
 ...
 */
declare class Builder implements IDisposable {
 ...
 */
declare class MultiBuilder extends Builder {
    length: number;
    private builders;
 ...
 */
declare function setPropertyOnElement(element: HTMLElement, key: string, value: any): void;
/**
 *  Allows to get arbritary data from element.
 */
declare function getPropertyFromElement(element: HTMLElement, key: string, fallback?: any): any;
/**
 *  Removes a property from an element.
 */
declare function removePropertyFromElement(element: HTMLElement, key: string): void;
/**
 *  Adds the provided object as property to the given element. Call getBinding()
 *  to retrieve it again.
 */
declare function bindElement(element: HTMLElement, object: any): void;
/**
 *  Removes the binding of the given element.
 */
declare function unbindElement(element: HTMLElement): void;
/**
 *  Returns the object that was passed into the bind() call for the element.
 */
declare function getBindingFromElement(element: HTMLElement): any;
declare let Binding: {
